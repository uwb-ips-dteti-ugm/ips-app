...
from ips_app_old.domain.models.user import User, UserAccessTokenClaims, UserRefreshTokenClaims
...
from ips_app_old.utils.token import create_access_token, create_refresh_token, validate_refresh_token
...
class AuthHTTPService(AuthHTTPPort):
    ...
    async def sign_out(self, user_id: Any) -> None:
        ...
        try:
            from ips_app_old.domain.models.user import UserState

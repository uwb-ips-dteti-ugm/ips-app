...
from ips_app_old.domain.models.user import User, UserPasswordAuth
...
from ips_app_old.domain.ports.driven.repository.permission import PermissionRepository
from ips_app_old.domain.ports.driven.repository.role import RoleRepository
from ips_app_old.domain.ports.driven.repository.user import UserRepository
from ips_app_old.domain.ports.driving.seeder.seeder import Seeder
from ips_app_old.config.seed_data import (
    ADMIN_ROLE_NAME,
    SEED_FEATURES,
    SEED_PERMISSIONS,
    SEED_ROLES,

...
# domain services
from ips_app_old.domain.services.http.auth.base import AuthHTTPService
from ips_app_old.domain.services.http.user.base import UserHTTPService
from ips_app_old.domain.services.http.role.base import RoleHTTPService
from ips_app_old.domain.services.http.permission.base import PermissionHTTPService
from ips_app_old.domain.services.http.feature.base import FeatureHTTPService
...
from ips_app_old.adapters.driving.http.handler.role import RoleHandler
from ips_app_old.adapters.driving.http.handler.permission import PermissionHandler
from ips_app_old.adapters.driving.http.handler.feature import FeatureHandler

# driving — routes
from ips_app_old.adapters.driving.http.routes import auth, user, role, permission, feature

# driving — middleware
from ips_app_old.adapters.driving.http.middleware.auth_jwt import JwtMiddleware
